...
JVM_OPTS="-Xmx12288m \
 ...
 -Dsas.auto.publish.host=bst-apx-20.lul.se \
 -Dsas.auto.publish.port=8080 \
 -Dsas.appserver.instance.id=SASServer1_1_bst-apx-20.lul.se \
