...
%macro load_lasrfromhadoop(VATABLE=, TAG=, PATH=, PORT=, SIGNER=);
	...
	* Olika Signer per LASR-server.;
	LIBNAME LASR SASIOLA  TAG=&tag  PORT=&port HOST="bs-ap-04.lul.se"  SIGNER="&signer";
	LIBNAME HADOOP SASHDAT  PATH="&path"  SERVER="bs-ap-04.lul.se"  INSTALL="/opt/TKGrid";
...
* Anrop;
%load_lasrfromhadoop(VATABLE=, TAG=hps, PATH=/hps, PORT=10010, SIGNER=https://bs-ap-04.lul.se:443/SASLASRAuthorization);
%load_lasrfromhadoop(VATABLE=, TAG=epj, PATH=/epj, PORT=10015, SIGNER=https://bs-ap-04.lul.se:443/SASLASRAuthorization);
%load_lasrfromhadoop(VATABLE=, TAG=lrc, PATH=/lrc, PORT=10016, SIGNER=https://bs-ap-04.lul.se:443/SASLASRAuthorization);
%load_lasrfromhadoop(VATABLE=, TAG=ftv, PATH=/ftv, PORT=10017, SIGNER=https://bs-ap-04.lul.se:443/SASLASRAuthorization);