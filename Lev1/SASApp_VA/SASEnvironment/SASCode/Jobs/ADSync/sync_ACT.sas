...
data _null_;
  ...
  * listar alla ACT:er som heter något på LUL-;
  put './sas-list-objects -host  bs-ap-20.lul.se -port 8561 -user sasadm@saspw -password {SAS002}7D55EB1F27B29BC354FD035416238B741C2BF86732381F40 -types ACT -name "LUL-" > /tmp/act.txt';
run;
...
data _null_ (encoding=utf8);
  ...
  put './sas-make-act -host  bs-ap-20.lul.se -port 8561 -user sasadm@saspw -password {SAS002}7D55EB1F27B29BC354FD035416238B741C2BF86732381F40 "' name 'ACT" -create -grant ' text;
  end;
...
data _null_ (encoding=utf8);
  ...
  put './sas-delete-objects -host  bs-ap-20.lul.se -port 8561 -user sasadm@saspw -password {SAS002}7D55EB1F27B29BC354FD035416238B741C2BF86732381F40 ' text;
run;
