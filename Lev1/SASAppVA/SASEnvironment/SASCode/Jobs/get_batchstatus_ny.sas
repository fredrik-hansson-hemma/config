...
%if &antalerror ne 0 %then %do;
        ...
        filename outbox email
        to=("mattias.moliis@infotrek.se" "fredrik.hansson@regionuppsala.se" "beslutsstod@support.lul.se"
 "hakan.edling@regionuppsala.se" "jan.von.knorring@regionuppsala.se")
        subject="&subject"
        attach=("&path.completejobs.html" "&path.errorjobs.html")
 ;
...
%if &antalerror_epj ne 0 %then %do;
        ...
        filename outbox email
        to=("mattias.moliis@infotrek.se" "fredrik.hansson@regionuppsala.se" "fredrik.lagerqvist@regionuppsala.se"
 "mats.eberhardsson@regionuppsala.se"
